...
/**
 * Classe da interface de sessão do tipo Deliberação
 * 
 * @author FLAPRANO
 * 
 */
public class SessaoDeliberacao extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Seta o layout definido no xml de layout "activity_sessao_deliberacao"
		setContentView(R.layout.activity_sessao_deliberacao);
		...
		if (sessao != null) {
			...
			nomeSessao = (TextView) findViewById(R.id.nome_SessaoDeliberacao);
			descricaoSessao = (TextView) findViewById(R.id.descricao_SessaoDeliberacao);
			dtInicial = (TextView) findViewById(R.id.dtInicial_SessaoDeliberacao);
			dtFinal = (TextView) findViewById(R.id.dtFinal_SessaoDeliberacao);

			btnYes = (ImageView) findViewById(R.id.btnYes_SessaoDeliberacao);
			btnNo = (ImageView) findViewById(R.id.btnNo_SessaoDeliberacao);
