...
/**
 * Classe da interface de sessão do tipo Confirmação
 * 
 * @author FLAPRANO
 * 
 */
public class SessaoConfirmacao extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Seta o layout definido no xml de layout "activity_sessao_confirmacao"
		setContentView(R.layout.activity_sessao_confirmacao);
		...
		if (sessao != null) {
			...
			nomeSessao = (TextView) findViewById(R.id.nome_SessaoConfirmacao);
			descricaoSessao = (TextView) findViewById(R.id.descricao_SessaoConfirmacao);
			dtInicial = (TextView) findViewById(R.id.dtInicial_SessaoConfirmacao);
			dtFinal = (TextView) findViewById(R.id.dtFinal_SessaoConfirmacao);

			btnYes = (ImageView) findViewById(R.id.btnYes_SessaoConfirmacao);
			btnNo = (ImageView) findViewById(R.id.btnNo_SessaoConfirmacao);
