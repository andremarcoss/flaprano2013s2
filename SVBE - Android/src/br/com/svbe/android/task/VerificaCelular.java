...
/**
 * Classe responsável pela tarefa de verificar se o celular já está cadastrado no banco de dados (através do uso do webservice)
 * 
...
public class VerificaCelular extends AsyncTask<String, Void, Boolean> {
	...
	// Método executado após a execução da tarefa (verifica se o usuário foi cadastrado ou não)
	@Override
	protected void onPostExecute(Boolean resultado) {
		if (resultado.equals(Boolean.FALSE)) {
			Toast aviso = Toast.makeText(CONTEXTO, "Usuário não cadastrado para esse celular.\nÉ necessário cadastrar um usuário.", Toast.LENGTH_LONG);
			aviso.show();
		}
	}
}
