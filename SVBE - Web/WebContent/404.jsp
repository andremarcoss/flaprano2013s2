...
<head>
    ...
    <title>SVBE - Página não encontrada</title>
</head>
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-9">
				<div class="jumbotron">
					...
					<p>A página que você tentou acessar não foi encontrada.<br>
					Isso pode ter sido causado por um erro ou a página pode não existir.</p>
				</div>
			</div>
		</div>
	</div>
